...
try:
    ...
    raise ImportError("fastapi is required for briq serve: pip install fastapi") from e

from briq.semantic import MetricLoader, SourceLoader, ExposureLoader, BriqMetric
