...
from briq.diff.comparison import ComparisonEngine
...
def compare_cmd(
    ...
    table = Table(title="briq compare")
    table.add_column("Model", style="cyan")
    table.add_column("briq rows", style="bold")
    ...
    if all_match and dbt_project_dir:
        ...
        console.print("[yellow]Some models differ between briq and dbt.[/yellow]")
        raise typer.Exit(1)
