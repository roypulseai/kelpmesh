...
from briq.core.packages import create_package, search_packages, package_info

console = Console()
package_app = typer.Typer(help="Manage briq packages")
...
def package_list(
    ...
    from briq.core.packages import list_packages
