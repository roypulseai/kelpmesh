"""briq studio — launch the bundled briq Studio web dashboard."""
...
def studio_cmd(
    ...
    """Launch briq Studio — the browser-based SQL IDE and DAG dashboard.
    ...
    Examples:
        briq studio
        briq studio --port 9000
        briq studio --project-dir /path/to/project
    """
    try:
        import uvicorn
    except ImportError:
        console.print(
            ...
            "  Install with: [bold]pip install briq\\[studio][/bold]\n"
        )
        raise typer.Exit(1)
    ...
    from briq.studio.app import create_app
    ...
    console.print()
    console.print(f"  [bold cyan]briq Studio[/bold cyan]  [dim]Pure SQL Transformation IDE[/dim]")
