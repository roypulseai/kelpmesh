"""briq seed — load CSV/TSV files from seeds/ directory or a specific file."""
...
def seed_cmd(
    ...
    Examples:
        briq seed                       # load all seeds
        briq seed seeds/countries.csv   # load one file
        briq seed --select countries    # same, by name
    """
    ...
    console.print(f"\n[bold]briq seed[/bold]  [dim]{project_path.name}[/dim]\n")
