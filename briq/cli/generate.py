"""briq generate — scaffold staging models and schema.yml from source table introspection."""
...
def generate_cmd(
    ...
    project_path: Path = typer.Option(Path("."), "--project-path", "-p", help="Path to briq project"),
):
    ...
    Example:
        briq generate raw.orders
        briq generate raw.customers --output-dir models/staging
    """
