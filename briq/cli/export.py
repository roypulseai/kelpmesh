"""briq export — export semantic layer to BI tool formats."""
...
def export_cmd(
    ...
    from briq.semantic import MetricLoader, SourceLoader, ExposureLoader
    ...
    results_table = Table(title="briq export", show_header=True)
