...
- Upload malware or malicious SQL
- Reverse-engineer the cloud Service
- Use the Service to process the data of third parties without their consent
...
- Free tier: no charge
- Pro: CHF 20/month per user
- Team: CHF 45/month per user
- Enterprise: custom pricing

All prices exclude VAT. Payments are processed by Stripe. We do not store credit card information.

## 7. Cancellation

You can cancel anytime. Your data is retained for 90 days after cancellation, then permanently deleted.
...
These Terms are governed by Swiss law. Any disputes shall be resolved in the courts of Zurich, Switzerland.

## 12. Changes

We will notify you 30 days before material changes to these Terms via email or in-app notice.
